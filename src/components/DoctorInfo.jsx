    ...
    return (
        <div className='flex min-h-screen font-fira  relative py-[5%] justify-center  items-center '>
            ...
            <div className='flex-1 flex items-start flex-col gap-y-3 sm:text-2xl text-xl'>
                ...
                <div>
                    <button onClick={()=> toast.success('You could have hired him/her if it was a real Site 🤣😂')} className='px-5 py-2 bg-black hover:bg-white hover:text-black duration-200 transition-all border cursor-pointer text-xl'>
                        Hire
                    </button>
                </div>
